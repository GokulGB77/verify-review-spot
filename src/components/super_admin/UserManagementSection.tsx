...
const UserManagementSection: React.FC = () => {
  ...
  const handleBlockUser = (userId: string) => {
    ...
    const isCurrentlyBlocked =
      user.rejection_reason === "Account blocked by admin";
  ...
  const filteredUsers = users?.filter((user) => {
    ...
    const emailMatch = user.email
      ?.toLowerCase()
      .includes(searchTerm.toLowerCase());
    const pseudonymMatch = user.pseudonym
      ?.toLowerCase()
      .includes(searchTerm.toLowerCase());
    const phoneMatch = user.phone?.includes(searchTerm);
    const matchesSearch =
      nameMatch || emailMatch || pseudonymMatch || phoneMatch;
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Manage platform users, verification status, and user preferences
        </CardDescription>
                              ...
                              {isEditMode ? (
                                <div className="p-4 border rounded-lg">
                                  <p className="text-sm text-gray-600">
                                    Edit form would go here. In a real
                                    application, this would be a comprehensive
                                    form for editing user details like name,
                                    email, phone, verification status, etc.
                                  </p>
                                ...
                                <>
                                  ...
                                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                      ...
                                      <p className="text-sm">
                                        {selectedUser.pseudonym || "Not set"}
                                      </p>
                                    </div>
                                    <div>
                                      <Label className="font-semibold">
                                      ...
                                      <p className="text-sm capitalize">
                                        {selectedUser.display_name_preference?.replace(
                                          "_",
                                          " "
                                        ) || "Full Name"}
                                      </p>
