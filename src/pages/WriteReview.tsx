...
const WriteReview = () => {
  ...
  // Check if supporting evidence should be shown
  const shouldShowSupportingEvidence = formData.reviewSpecificBadge === 'Verified Employee' || formData.reviewSpecificBadge === 'Verified Student';
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Proof Upload - Only show when Employee or Student is selected */}
          {shouldShowSupportingEvidence && (
            <Card>
              <CardHeader>
